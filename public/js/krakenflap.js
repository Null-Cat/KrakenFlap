...
function preload() {
  ...
  this.load.spritesheet('player', 'js/assets/player.png', {
    frameWidth: 80,
    frameHeight: 24
  })
  this.load.spritesheet(assets.textButton, 'js/assets/blackbox.png', {
    frameWidth: 150,
    frameHeight: 50
  })
  this.load.spritesheet(assets.interface.button.play, 'js/assets/blackboxPlay.png', {
    frameWidth: 150,
    frameHeight: 50
  })
  this.load.spritesheet(assets.interface.button.leaderboard, 'js/assets/smallButtonPoduim.png', {
    frameWidth: 65,
    frameHeight: 50
  })
  this.load.spritesheet(assets.interface.button.settings, 'js/assets/smallButtonSettings.png', {
    frameWidth: 65,
    frameHeight: 50
  })
  this.load.spritesheet(assets.interface.button.back, 'js/assets/smallButtonBack.png', {
    frameWidth: 65,
    frameHeight: 50
  })
...
function create() {
  const userid = document.getElementById('krakenflap').getAttribute('userid')
  this.add
    .text(3, 512, `User ID: ${userid || 'ERR'}`, {
      font: '14px kenney_mini_square_regular',
      fill: '#ffffff',
      align: 'center'
    })
    .setOrigin(0, 1.1)
  ...
  const buttonPlay = new uiWidgets.TextButton(
    this,
    screenCenterWidth,
    screenCenterHeight + 100,
    assets.interface.button.play,
    () => {
      click.play()
    ...
    // .setText('Play', buttonTextStyle)
    .setDepth(30)
  buttonPlay.button.on('pointerover', () => {
    bong.play()
  })

  // eslint-disable-next-line no-undef
  const buttonLeaderboard = new uiWidgets.TextButton(
    this,
    0,
    0,
    assets.interface.button.leaderboard,
    () => {
      click.play()
      fromMenu = true
    ...
    .setDepth(30)
  buttonLeaderboard.button.on('pointerover', () => {
    bong.play()
  })
  const buttonSettings = new uiWidgets.TextButton( // eslint-disable-line no-undef
    this,
    0,
    0,
    assets.interface.button.settings,
    () => {
      click.play()
      showSettings()
      fromMenu = true
  ...
  buttonSettings.button.on('pointerover', () => {
    bong.play()
  })
  menuScreenButtons.push(buttonPlay, buttonLeaderboard, buttonSettings)
  ...
  globalLeaderboardTitle = this.add
    ...
    .setOrigin(0.5)
    .setDepth(30)
  globalLeaderboardBackButton = new uiWidgets.TextButton( // eslint-disable-line no-undef
    this,
    -2,
    1,
    assets.textButton,
    () => {
      ...
      globalLeaderboardBackButton.visible = false
    ...
    .setText('Back', buttonTextStyle)
    .setDepth(30)
  globalLeaderboardBackButton.button.on('pointerover', () => {
    bong.play()
  })
  const backButtonColumn = new uiWidgets.Column(this, screenCenterWidth, 450).setDepth(30) // eslint-disable-line no-undef
  backButtonColumn.addNode(globalLeaderboardBackButton, 0, 0)
  globalLeaderboardBackButton.visible = false
  globalLeaderboardTitle.visible = false
  ...
  fourthAndFifthPlaceText.forEach((player) => {
    globalLeaderboardTopPlayersColumn.addNode(player, 0, 10)
  })

  const settingsTitle = this.add
    .text(screenCenterWidth + 7, screenCenterHeight - 200, 'Settings', {
      font: '42px kenney_mini_square_regular',
      fill: '#ffffff',
      align: 'center'
    })
    .setOrigin(0.5)
    .setDepth(30)
  const settingsButtonBGMFilled = new uiWidgets.TextButton( // eslint-disable-line no-undef
    this,
    screenCenterWidth - 40,
    screenCenterHeight - 50,
    assets.interface.button.settingsButton.filled,
    () => {
      click.play()
      settingsButtonBGMEmpty.visible = true
      settingsButtonBGMFilled.visible = false
      bgm.stop()
    },
    this,
    0,
  ...
  const settingsButtonBGMEmpty = new uiWidgets.TextButton( // eslint-disable-line no-undef
    ...
    screenCenterWidth - 40,
    screenCenterHeight - 50,
    assets.interface.button.settingsButton.empty,
    () => {
      click.play()
      settingsButtonBGMEmpty.visible = false
      settingsButtonBGMFilled.visible = true
      bgm.play()
    },
    this,
    0,
  ...
  const settingsButtonSFXFilled = new uiWidgets.TextButton( // eslint-disable-line no-undef
    this,
    screenCenterWidth - 40,
    screenCenterHeight - 10,
    assets.interface.button.settingsButton.filled,
    () => {
      click.play()
      settingsButtonSFXEmpty.visible = true
      settingsButtonSFXFilled.visible = false
      toggleSFX = false
    },
    this,
    0,
  ...
  const settingsButtonSFXEmpty = new uiWidgets.TextButton( // eslint-disable-line no-undef
    ...
    () => {
      click.play()
      settingsButtonSFXEmpty.visible = false
      settingsButtonSFXFilled.visible = true
      toggleSFX = true
    },
    this,
    0,
  ...
  const settingsOptionTextBGM = this.add
    .text(screenCenterWidth + 10, screenCenterHeight - 55, 'BGM', {
      font: '26px kenney_mini_square_regular',
      fill: '#ffffff',
      align: 'center'
    })
    .setOrigin(0.5)
    .setDepth(30)
  const settingsOptionTextSFX = this.add
    .text(screenCenterWidth + 10, screenCenterHeight - 15, 'SFX', {
      font: '26px kenney_mini_square_regular',
      fill: '#ffffff',
      align: 'center'
    })
  ...
  const settingsBackButton = new uiWidgets.TextButton( // eslint-disable-line no-undef
    ...
    .setText('Back', buttonTextStyle)
    .setDepth(30)
  settingsBackButton.button.on('pointerover', () => {
    bong.play()
  })
...
function prepareGame(scene) {
  ...
  tentacleSpawnTimer = scene.time.addEvent({
    delay: 2000,
    callback: createTentacles,
    callbackScope: this,
    loop: true
  })
...
function movePlayer() {
  ...
  jumpTimer = game.scene.scenes[0].time.addEvent({
    delay: 100,
    callback: () => {
      jumping = false
    },
  ...
  if (toggleSFX) game.scene.scenes[0].sound.add(assets.audio.splash, { loop: false }).play()
}
