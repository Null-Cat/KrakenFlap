...
function create() {
    ...
    instructions = this.add.image(screenCenterWidth, 400, 'instructions');
    instructions.setDepth(30);
    instructions.visible = true;

    gameOverBanner = this.add.image(screenCenterWidth, 156, 'gameOver');
...
function update() {
    ...
    if (coffeeQueued > 0 && Math.floor(tentacleSpawnTimer.elapsed) >= Math.floor(tentacleSpawnTimer.delay * .2)) {
        coffeeQueued--;
        createCoffee();
    }
